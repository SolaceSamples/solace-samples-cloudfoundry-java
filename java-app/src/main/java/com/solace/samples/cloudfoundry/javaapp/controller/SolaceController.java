package com.solacesystems.cloudfoundry.demos.intro.controller;
...
import com.solacesystems.cloudfoundry.demos.intro.model.SimpleMessage;
import com.solacesystems.cloudfoundry.demos.intro.model.SimpleSubscription;
...
public class SolaceController {
	...
	public void init() {
		...
		if (vcapServices == null || vcapServices.equals("") || vcapServices.equals("{}")) {
			logger.error("Did not find user provided service. Aborting conenction");
			return;
		}
